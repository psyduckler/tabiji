#!/usr/bin/env python3
"""
Build the paperback-interior PDF for the Thailand book.
...
INTERIOR_HTML = BUILD / "thailand-scams-paperback.html"
INTERIOR_PDF = BUILD / "thailand-scams-paperback.pdf"
