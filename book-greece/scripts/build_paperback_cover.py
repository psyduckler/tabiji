#!/usr/bin/env python3
"""
Build the KDP paperback wraparound cover PDF for the Greece book.
...
OUT_SVG = BOOK / "build" / "greece-paperback-cover.svg"
OUT_PDF = BOOK / "build" / "greece-paperback-cover.pdf"
