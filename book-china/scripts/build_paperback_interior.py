#!/usr/bin/env python3
"""
Build the paperback-interior PDF for the China book.
...
Usage:
    python3 book-china/scripts/build_paperback_interior.py
...
INTERIOR_HTML = BUILD / "china-scams-paperback.html"
INTERIOR_PDF = BUILD / "china-scams-paperback.pdf"
...
def build_html(md: str) -> Path:
    ...
    title = CONFIG.get("title", "China Tourist Scams 2026")
