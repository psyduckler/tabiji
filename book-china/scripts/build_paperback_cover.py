#!/usr/bin/env python3
"""
Build the KDP paperback wraparound cover PDF for the China book.
...
12.845" x 9.25" including the 0.125" bleed.
...
OUT_SVG = BOOK / "build" / "china-paperback-cover.svg"
OUT_PDF = BOOK / "build" / "china-paperback-cover.pdf"
...
def main() -> None:
    ...
    ap.add_argument("--pages", type=int, default=326,
  ...
  <!-- ================================================================ -->
  <!-- CHINA PAPERBACK WRAPAROUND COVER                                 -->
