#!/usr/bin/env python3
"""Write complete Tokyo itinerary data and generate fulfillment script."""
import json, os
...
data = {
  ...
  "description": ("You're arriving in Tokyo at the exact moment the city transforms. Late March is when the first "
    "sakura burst open \u2014 Shinjuku Gyoen's 1,000 trees, the lantern-lit canal at Meguro River, the moat at "
    "Chidorigafuchi turning pink. This itinerary is built for solo travelers: counter-seat ramen shops, standing "
    "sushi bars, sprawling temple grounds you can wander alone, and neighborhoods like Shimokitazawa and Yanaka "
    "where the pace slows down. Tokyo is one of the world's great solo cities \u2014 everything is designed for a party of one."),
  "duration": "3 nights",
  ...
  "essentials": [
    {"title": "\U0001f338 Cherry Blossom Timing",
     "text": ("Late March is early bloom season \u2014 March 20\u201323 falls right at first bloom (typically March 22\u201326). "
              "You'll catch the magical transition from buds to first petals. Shinjuku Gyoen has early-blooming varieties "
              "that peak before Somei Yoshino. Check real-time sakura forecasts on japan-guide.com.")},
    {"title": "\U0001f687 Getting Around",
     "text": ("Get a 72-hour Tokyo Metro pass (\u00a51,500/~$10) or a Suica/Pasmo IC card \u2014 tap-on, works on all trains, "
              "buses, and convenience stores. Google Maps transit is flawless in Tokyo. Trains run 5am\u2013midnight. "
              "For late nights, taxi or walk \u2014 Tokyo is extremely safe at any hour.")},
    {"title": "\U0001f35c Solo Dining Culture",
     "text": ("Tokyo is the world capital of solo dining. Counter seats at ramen shops, conveyor belt sushi (kaitenzushi), "
              "standing bars (tachinomi), and ticket-machine restaurants are all designed for one. No awkwardness, no judgment "
              "\u2014 eating alone is completely normal. Ichiran even has private booths with curtains.")},
    {"title": "\U0001f4b4 Money & Tipping",
     "text": ("Japan is increasingly cashless (IC cards, PayPay), but carry \u00a510,000\u201320,000 cash for small shops, shrines, "
              "and market stalls. Tipping is NOT customary \u2014 the price is the price. 7-Eleven, Lawson, and FamilyMart "
              "have international ATMs and genuinely excellent food.")}
  ],
  "days": [
    # ── Day 1 ──
    {
      ...
      "description": ("Start in the heart of Tokyo's biggest district. Morning in the serene gardens of Shinjuku Gyoen "
                      "chasing early cherry blossoms, afternoon exploring the labyrinthine streets around the station, "
                      "evening diving into Kabukicho's electric nightlife \u2014 all within walking distance."),
      "timeBlocks": [
        {
          "label": "Morning",
          "activities": [{
            "title": "Shinjuku Gyoen National Garden",
            "description": ("Tokyo's finest cherry blossom garden \u2014 58 hectares with 1,000+ trees across 70+ varieties, "
                            "including early-blooming kanzan and shidarezakura (weeping cherry). Arrive at opening to "
                            "have the grounds nearly to yourself. The Japanese Traditional Garden, sakura reflecting in the "
                            "pond, is the most photogenic spot in the city."),
            "details": [
              "\U0001f338 \u00a5500 entry \u00b7 Opens 9:00am \u00b7 No alcohol (keeps it peaceful)",
              "\U0001f4f8 Best spots: Japanese Garden pond, English Landscape lawn, Taiwan Pavilion",
          ...
          "meals": [{"type": "\u2615 Breakfast", "name": "Konbini Coffee & Onigiri",
          ...
          "tips": [{"type": "tip", "text": ("Shinjuku Gyoen opens at 9am sharp. Be in line by 8:50 \u2014 the first "
                                             "30 minutes are magical before tour groups arrive. Use the Shinjuku Gate entrance.")}]
        },
        {
          "label": "Afternoon",
          "activities": [
            {"title": "Omoide Yokocho (Memory Lane)",
             "description": ("Narrow strip of tiny yakitori stalls behind Shinjuku Station's west exit, here since "
                             "the post-war era. Each stall seats 6\u20138 at smoky counters. Order chicken skewers and a "
                             "draft beer, watch the grill master work \u2014 old Tokyo at its finest."),
             "details": ["\U0001f3ee Each stall seats 6\u20138 \u2014 perfect for solo counter dining",
                         "\U0001f362 Must-try: negima (chicken & leek), tsukune (meatball), kawa (crispy skin)",
                         "\U0001f4b0 Cash only at most stalls"]},
            {"title": "Tokyo Metropolitan Government Building Observatory",
             "description": ("Free observation deck on the 45th floor with panoramic views \u2014 on clear days you can "
                             "see Mt. Fuji. No ticket needed, just security and elevator. One of Tokyo's best free attractions."),
        ...
        },
        {
          ...
          "activities": [{"title": "Kabukicho & Golden Gai",
                          "description": ("Tokyo's most famous nightlife district. Kabukicho is neon-drenched \u2014 Godzilla "
                                         ...
                                         "200+ tiny bars seating 5\u201310 each. Many welcome solo travelers; this is where you "
                                         "make friends over whisky."),
                          "details": ["\U0001f37a Golden Gai \u2014 \u00a5500\u20131000 cover + drinks from \u00a5700",
          ...
          "meals": [{"type": "\U0001f377 Dinner", "name": "Omoide Yokocho Yakitori Round 2",
                     "description": ("Return to Memory Lane for dinner \u2014 it transforms at night when lanterns glow "
                                     "and smoke billows. Pick any stall, counter seat, charcoal-grilled chicken with cold Asahi."),
                     "meta": "\U0001f4b0 $$ \u00b7 \U0001f4cd Omoide Yokocho, Shinjuku west exit \u00b7 Cash only"}],
          "tips": [{"type": "tip", "text": ("Golden Gai is best around 8\u20139pm. Bars are tiny \u2014 if one's full, "
                                            "try next door. There are 200+ options. Many bartenders speak some English.")}]
        }
      ],
      "mapPins": [
    ...
    # ── Day 2 ──
    {
      ...
      "description": ("A journey through time. Dawn at the 7th-century Senso-ji Temple, morning in nostalgic Yanaka, "
                      "afternoon cherry blossoms at Ueno Park, and evening in Akihabara's electric wonderland. "
                      "East Tokyo is where tradition and obsession collide."),
      "timeBlocks": [
        {
          "label": "Morning",
          "activities": [
            {"title": "Senso-ji Temple at Dawn",
             "description": ("Tokyo's oldest temple (founded 645 AD) is packed by 10am \u2014 but at 6:30am, you'll have "
                             "the Thunder Gate, massive red lantern, and incense-filled main hall to yourself. "
                             "Nakamise shopping street is shuttered and atmospheric. Walk slowly, breathe the incense."),
             "details": ["\u26e9\ufe0f Grounds open 24h \u00b7 Main hall opens 6:00\u20136:30am",
            ...
            {"title": "Yanaka Ginza & Yanaka Cemetery",
             "description": ("Yanaka survived WWII firebombing and feels like 1950s Tokyo. Retro shopping street with "
                             "street food, cat statues, zero chain stores. The adjacent cemetery has a stunning cherry "
                             "blossom tunnel \u2014 a canopy of sakura lines the main path."),
             "details": ["\U0001f431 Tokyo's cat town \u2014 real cats and cat-themed shops everywhere",
                         "\U0001f338 Yanaka Cemetery sakura tunnel \u2014 most peaceful blossom spot",
          ...
          "tips": [{"type": "tip", "text": ("From Senso-ji, take the Yamanote Line from Uguisudani to Nippori for Yanaka. "
                                            "15 minutes and feels like teleporting to a different era.")}]
        },
        {
          "label": "Afternoon",
          "activities": [
            {"title": "Ueno Park Cherry Blossoms",
             "description": ("Japan's most famous hanami park \u2014 1,000+ cherry trees line the main avenue, and during "
                             "bloom the path becomes a pink tunnel with families picnicking underneath. "
                             "Grab a konbini bento and sit under the trees like a local."),
             "details": ["\U0001f338 Main cherry avenue is the classic hanami scene",
                         "\U0001f3db\ufe0f Tokyo National Museum \u2014 Japan's oldest & largest (\u00a51,000)",
                         "\U0001f9a2 Shinobazu Pond \u2014 rent a swan boat solo",
                         "\U0001f371 Konbini bento + Strong Zero under sakura = peak Tokyo"]},
            {"title": "Ameyoko Market",
             "description": ("Bustling open-air market under the Yamanote Line tracks. Fresh seafood, dried fruits, "
                             "chocolate strawberries \u2014 Southeast Asian energy right in central Tokyo."),
          ...
          "meals": [{"type": "\U0001f35c Lunch", "name": "Sansada Tempura",
                     "description": ("Operating since 1837 \u2014 Asakusa institution serving crispy tempura at the counter. "
                                     "Watch each piece fried to order. The tendon (tempura rice bowl) is ~\u00a51,500 and legendary."),
        ...
        },
        {
          ...
          "activities": [{"title": "Akihabara Electric Town",
                          ...
                          "details": ["\U0001f3ae Super Potato \u2014 5 floors retro games, playable consoles on top",
                                      "\U0001f4e6 Mandarake \u2014 massive secondhand manga and collectibles",
                                      "\U0001f579\ufe0f Arcades \u2014 crane games, rhythm games, purikura",
          ...
          "meals": [{"type": "\U0001f377 Dinner", "name": "Kanda Yabu Soba",
                     "description": ("One of Tokyo's three great soba restaurants, established 1880. Hand-cut buckwheat "
                                     "noodles served cold on bamboo with dipping sauce. Minimalist, meditative, perfect "
                                     "for solo dinner. Beautiful traditional wooden building."),
                     "meta": "\U0001f4b0 $$ \u00b7 \U0001f4cd Kanda, between Akihabara and Ueno"}],
          "tips": [{"type": "tip", "text": ("For solo conveyor belt sushi, try Sushiro or Kura Sushi \u2014 order from "
                                            "a tablet, sushi arrives on a mini train. No interaction needed, no awkwardness.")}]
        }
      ],
      "mapPins": [
      ...
      "timeBlocks": [
          ...
          "activities": [
            {"title": "Meiji Shrine (Meiji Jingu)",
             ...
             "details": ["\u26e9\ufe0f Free entry \u00b7 Opens at sunrise (~5:40am in March)",
                         ...
                         "\U0001f4f8 The massive cypress torii gate is the photo",
                         "\U0001f38b Ema plaque (\u00a5500) \u2014 write a wish, read others'"]},
            {"title": "Harajuku & Takeshita Street",
             "description": ("Ancient forest to youth fashion capital. Takeshita Street: crepe shops, kawaii fashion, "
                             "sensory overload. Cat Street one block over: cooler, less crowded, with independent boutiques."),
        ...
        },
        {
          ...
          "activities": [{"title": "Shimokitazawa",
                          "description": ("Tokyo's most beloved bohemian neighborhood \u2014 narrow streets packed with "
                                         "vintage clothing shops, record stores, tiny curry restaurants, and live music venues. "
                                         "Feels like a village inside a megacity. Perfect for aimless solo wandering."),
                          "details": ["\U0001f455 Vintage shops: Flamingo, Stick Out, New York Joe Exchange",
                                      "\U0001f35b Curry town \u2014 try Curry Spice Gelateria",
          ...
          "meals": [{"type": "\U0001f35c Lunch", "name": "Curry Spice Gelateria",
                     "description": ("Shimokitazawa original \u2014 artisanal curry with rotating spice-infused gelatos for dessert. "
                                     "Counter seats, solo-perfect."),
          ...
          "tips": [{"type": "tip", "text": ("Shimokitazawa is 3 stops from Shibuya on the Keio-Inokashira line. "
                                            "South side = vintage shops, north side = food. Just wander \u2014 best discoveries are unplanned.")}]
        },
        {
          "label": "Evening",
          "activities": [
            {"title": "Meguro River Cherry Blossoms at Night",
             "description": ("The 4km stretch from Nakameguro to Meguro is lined with 800+ cherry trees. "
                             "During bloom, thousands of pink paper lanterns illuminate the petals \u2014 reflections "
                             "ripple in the water below. Walk the entire length, stopping at pop-up bars and wine stands."),
            ...
            {"title": "Shibuya Crossing",
             "description": ("The world's busiest intersection. Watch from the Starbucks 2F for the aerial view, "
                             "then cross with the crowd. Find the Hachiko statue at the north exit."),
          ...
          "meals": [{"type": "\U0001f377 Dinner", "name": "Afuri Ramen Nakameguro",
                     "description": ("Light, refreshing yuzu shio (citrus salt) ramen \u2014 clear golden broth with a "
                                     "yuzu punch, completely different from heavy tonkotsu. Counter-seat-only. Perfect after a sakura walk."),
    ...
    # ── Day 4 ──
    {
      ...
      "description": ("Your final day is Tokyo at its most refined. Morning at Chidorigafuchi \u2014 the Imperial Palace "
                      "moat becomes a tunnel of cherry blossoms, best seen from a rowboat. Fresh sushi at Tsukiji Outer "
                      "Market. Afternoon in elegant Ginza. Evening under the illuminated weeping cherry at Rikugien Garden."),
      "timeBlocks": [
        {
          "label": "Morning",
          "activities": [
            {"title": "Chidorigafuchi Cherry Blossoms & Boat Ride",
             "description": ("The most iconic sakura scene in all of Tokyo \u2014 260 cherry trees arch over the Imperial "
                             "Palace moat, forming a pink tunnel reflected in the green water. Rent a rowboat and drift "
                             "under the canopy. Arrive early \u2014 boat queues build fast during bloom."),
             "details": ["\U0001f6a3 Boat rental: \u00a5800/30min \u00b7 Opens 9:30am during sakura season",
                         "\U0001f338 Walkway along the moat is equally beautiful without a boat",
