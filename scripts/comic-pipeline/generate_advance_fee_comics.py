#!/usr/bin/env python3
"""Generate the 5 advance-fee-loan-and-debt-relief comics via gpt-image-2."""
...
NEW_PAGE = "advance-fee-loan-and-debt-relief"
TARGETS = [m for m in MANIFEST if m[0] == NEW_PAGE]


def main():
    ws = _keychain("wavespeed-api-key")
    if not ws: print("ERROR", flush=True); sys.exit(1)
