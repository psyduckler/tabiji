...
## Status (as of 2026-04-27, post-258-page session)
- **Done so far:** ~258 pages at 100/100 (~28.2% of 916 total compare pages).
- **Remaining sub-100:** ~658 pages. Top 50 by impact saved in `scripts/queues/compare-batch-50.json` — **regenerate before starting a new session** (most of the entries from the prior queue are now done).
