...
writePage('compare/index.html', pageHtml({
  ...
  heroStats: [{ value: String(cards.length), label: 'published comparisons' }, { value: String(regionDefinitions.length), label: 'regional hubs' }, { value: String(typeDefinitions.length), label: 'trip-type hubs' }],
