...
OUT_SVG = BOOK / "build" / "argentina-paperback-cover.svg"
OUT_PDF = BOOK / "build" / "argentina-paperback-cover.pdf"
...
def paperback_back_content(back_inner: str) -> str:
    ...
    - Relabel footer from KINDLE EDITION → PAPERBACK EDITION and nudge it
      ...
      cover). The Argentina eBook back.svg does not include a QR panel, so we
