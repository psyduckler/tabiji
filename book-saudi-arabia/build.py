...
CITY_ALT_TEXT: dict[str, str] = {
    "cairo": "Stylized illustration of Cairo — the Giza pyramids and the Sphinx at golden hour",
    "luxor": "Stylized illustration of Luxor — Karnak Temple's columned hall above the Nile",
    "aswan": "Stylized illustration of Aswan — feluccas at sunset on the Nile near Elephantine Island",
    "hurghada": "Stylized illustration of Hurghada — Red Sea reef and dive boats off Sahl Hasheesh",
    "sharm-el-sheikh": "Stylized illustration of Sharm El Sheikh — Naama Bay promenade and turquoise reef",
    "alexandria": "Stylized illustration of Alexandria — the Qaitbay Citadel above the Eastern Harbor",
    "dahab": "Stylized illustration of Dahab — the Blue Hole and Sinai mountains behind palm-shaded shore",
}
