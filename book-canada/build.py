...
CITY_ALT_TEXT: dict[str, str] = {
    ...
    # Canada volume
    "toronto": "Toronto — CN Tower and red streetcar at golden hour",
    "niagara-falls": "Niagara Falls — Horseshoe Falls with Maid of the Mist at golden hour",
    "ottawa": "Ottawa — Parliament Hill and Peace Tower at dusk",
    "montreal": "Montreal — Vieux-Port and Basilique Notre-Dame in early winter",
    "quebec-city": "Quebec City — Château Frontenac and Dufferin Terrace at golden hour",
    "halifax": "Halifax — Halifax Harbour and Citadel at golden hour",
    "calgary": "Calgary — Calgary Tower and the Rockies at sunset",
    "banff": "Banff — Moraine Lake and the Ten Peaks at dawn",
    "jasper": "Jasper — Maligne Lake and Spirit Island at golden hour",
    "whistler": "Whistler — Whistler Village with Blackcomb and Whistler peaks at dusk",
    "vancouver": "Vancouver — Coal Harbour and the North Shore mountains at sunset",
    "victoria-bc": "Victoria BC — Inner Harbour and BC Parliament at golden hour",
    # Indonesia volume
    "jakarta": "Jakarta — Kota Tua colonial facades and the Jakarta History Museum at golden hour",
    "yogyakarta": "Yogyakarta — Borobudur sunrise with Mount Merapi in the distance",
    "mount-bromo": "Mount Bromo — volcanic caldera at sunrise with Mount Semeru",
    "ijen-crater": "Ijen Crater — turquoise acid lake and sulfur miners at dawn",
    "bali": "Bali — Tanah Lot sea-temple at sunset",
    "ubud": "Ubud — Tegallalang rice terraces at golden hour",
    "seminyak": "Seminyak — beach-club sunset with Mount Agung silhouette",
    "nusa-penida": "Nusa Penida — Kelingking Beach cliff viewpoint",
    "gili-islands": "Gili Islands — sunset jetty toward Mount Rinjani",
    "lombok": "Lombok — Mount Rinjani caldera lake at dawn",
    "labuan-bajo": "Labuan Bajo — Komodo park bay with Phinisi schooners",
    "batam": "Batam — Barelang Bridge toward Singapore's skyline at dusk",
    # Vietnam volume
...
def build_epub(md: str) -> Path:
    ...
    cmd = [
        ...
        # and "P$ Montreal" which pandoc otherwise treats as math delimiters,
        # mangling whole paragraphs into <em>-per-letter gibberish.
