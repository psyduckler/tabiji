...
Usage:
    python3 book-france/scripts/build_paperback_cover.py                 # 358 pages, cream
    python3 book-france/scripts/build_paperback_cover.py --pages 360
...
OUT_SVG = BOOK / "build" / "france-paperback-cover.svg"
OUT_PDF = BOOK / "build" / "france-paperback-cover.pdf"
