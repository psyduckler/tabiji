...
Usage:
    python3 book-austria/build.py

Produces: book-austria/build/austria-scams.epub
...
CITY_ALT_TEXT: dict[str, str] = {
    "vienna": "Stylized illustration of Vienna — St. Stephen's Cathedral and the Hofburg rooftops at golden hour",
    "wachau": "Stylized illustration of the Wachau valley — Dürnstein's blue church tower above the Danube and terraced vineyards",
    "linz": "Stylized illustration of Linz — the main square and Pöstlingberg church above the Danube",
    "salzburg": "Stylized illustration of Salzburg — the Hohensalzburg Fortress above the old town and Salzach river",
    "hallstatt": "Stylized illustration of Hallstatt — pastel lakeside houses and church spire beneath alpine cliffs",
    "bad-gastein": "Stylized illustration of Bad Gastein — Belle Époque hotels stacked above the waterfall in the alpine gorge",
    "zell-am-see": "Stylized illustration of Zell am See — the lakeside town beneath the snow-capped Kitzsteinhorn glacier",
    "innsbruck": "Stylized illustration of Innsbruck — colorful Maria-Theresien-Strasse facades beneath the Nordkette mountains",
    "graz": "Stylized illustration of Graz — the Schlossberg clock tower above the red-roofed old town",
}
