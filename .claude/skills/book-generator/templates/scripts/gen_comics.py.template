#!/usr/bin/env python3
"""
Generate the Turkey book cover art via Wavespeed (Nano Banana Pro):
 - front cover (dramatic 2:3 portrait scene, Sultanahmet shoe-shine brush drop)
 - back cover (2:3 portrait scene of a Turkish bazaar evening with warm lantern light)

Scam-comic assets for the 78 Turkish scams already live on R2 and are downloaded
into book-turkey/assets/images/<slug>/NN.jpg by the initial setup step.
This script only needs to generate the two covers.

Usage:
    python3 book-turkey/scripts/gen_comics.py
    python3 book-turkey/scripts/gen_comics.py --front-only
    python3 book-turkey/scripts/gen_comics.py --back-only
"""
...
COVERS = [
    (
        ...
        (
            ...
            "depicting a Turkey tourist scam in action on Sultanahmet Square in "
            "Istanbul: a female tourist in a sun hat stands on the stone-paved "
            "square between the massive domed silhouette of the Blue Mosque "
            "(with its six minarets) and the Hagia Sophia. In the middle ground, "
            "a Turkish man in a simple shirt is walking ahead of her with a "
            "shoe-shine box; his polish brush has fallen to the ground just "
            "between her and him. A friendly-looking Turkish man in a vest is "
            "gesturing at the fallen brush saying 'You dropped — I thank you, "
            "shine shoes, very cheap!' in a white speech bubble. Warm "
            "golden-hour saffron-to-dusty-purple sky. Composition leaves "
    ...
    (
        ...
        (
            ...
            "a bustling Turkish bazaar evening from a three-quarter overhead "
            "view: the vaulted ceiling of a covered bazaar (like Istanbul's "
            "Grand Bazaar, Kapalıçarşı) with warm hanging lanterns and Turkish "
            "lamps glowing amber-and-saffron, walls lined with piled carpets "
            "and kilims in red and gold, copper and brass items on shelves, "
            "a few silhouetted figures browsing the stalls, the distant glow "
            "of a tea house at the end of the arcade. Composition is "
            "atmospheric and calm, with substantial empty dusty-purple ceiling "
            "and upper-wall area in the upper two-thirds of the frame to leave "
            "space for back-cover copy to be overlaid. Palette: pastel "
            "watercolor, warm amber lantern glow, hints of saffron and burgundy "
