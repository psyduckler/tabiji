#!/usr/bin/env python3
"""
Build the KDP paperback wraparound cover PDF for the Spain book.
...
Default --pages (358, cream) matches the final Spain interior at 6x9 trim
...
OUT_SVG = BOOK / "build" / "spain-paperback-cover.svg"
OUT_PDF = BOOK / "build" / "spain-paperback-cover.pdf"
...
def main() -> None:
    ...
    ap.add_argument("--pages", type=int, default=358,
  ...
  <!-- ================================================================ -->
  <!-- SPAIN PAPERBACK WRAPAROUND COVER                                 -->
