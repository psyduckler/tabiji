#!/usr/bin/env python3
"""
Build the KDP paperback wraparound cover PDF for the Vietnam book.
...
OUT_SVG = BOOK / "build" / "portugal-paperback-cover.svg"
OUT_PDF = BOOK / "build" / "portugal-paperback-cover.pdf"
...
def main() -> None:
  ...
  <!-- ================================================================ -->
  <!-- VIETNAM PAPERBACK WRAPAROUND COVER                              -->
