...
Usage:
    python3 book-indonesia/scripts/build_paperback_interior.py
...
INTERIOR_HTML = BUILD / "indonesia-scams-paperback.html"
INTERIOR_PDF = BUILD / "indonesia-scams-paperback.pdf"
...
def build_html(md: str) -> Path:
    ...
    title = CONFIG.get("title", "Indonesia Tourist Scams 2026")
