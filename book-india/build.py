...
Usage:
    python3 book-egypt/build.py

Produces: book-egypt/build/egypt-scams.epub
...
CITY_ALT_TEXT: dict[str, str] = {
    "delhi": "Stylized illustration of Delhi — India Gate at twilight above the Rajpath",
    "agra": "Stylized illustration of Agra — the Taj Mahal in dawn light reflected in the Yamuna",
    "jaipur": "Stylized illustration of Jaipur — the pink-sandstone Hawa Mahal in afternoon sun",
    "udaipur": "Stylized illustration of Udaipur — the white marble Lake Palace afloat on Lake Pichola",
    "varanasi": "Stylized illustration of Varanasi — the Ganga ghats at the evening Aarti",
    "kolkata": "Stylized illustration of Kolkata — the Howrah Bridge above the Hooghly at dusk",
    "mumbai": "Stylized illustration of Mumbai — the Gateway of India and Arabian Sea behind the Taj Hotel",
    "goa": "Stylized illustration of Goa — palm-fringed Baga Beach with a fishing boat on the sand",
    "bangalore": "Stylized illustration of Bangalore — Vidhana Soudha in late-afternoon golden light",
    "hyderabad": "Stylized illustration of Hyderabad — the four minarets of Charminar above Laad Bazaar",
    "chennai": "Stylized illustration of Chennai — Marina Beach at sunrise with the Lighthouse silhouette",
    "rishikesh": "Stylized illustration of Rishikesh — Lakshman Jhula across the Ganga with Himalayan foothills behind",
}
