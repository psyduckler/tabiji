...
Walk to the nearest Carabinieri or Polizia di Stato station. Most tourist districts have one within a ten-minute walk, and Italian stations almost always have an English-speaking officer on shift. Say *"Sono stato truffato"* (or *"Sono stata truffata"* if you are a woman) — *"I was scammed"* — or *"mi hanno borseggiato"* (*they pickpocketed me*). Ask for a *denuncia*, the formal crime report. You will need the denuncia number for every subsequent step: the card chargeback, the travel-insurance claim, the embassy replacement passport. You do not need perfect Italian for this.

For pickpocketing specifically, you can also file the denuncia online at **[denunceonline.poliziadistato.it](https://denunceonline.poliziadistato.it)** and pick up the signed copy at any police station within forty-eight hours. This is faster than waiting at the station for the paper version, especially if you need to catch a train.

Freeze the card that was used. International emergency lines for the major card issuers are listed in Appendix C. These numbers work from Italy and route you to an English-speaking representative. Have your card number (or at least the last four digits) and the approximate transaction amount ready before you call. If the scam was a restaurant overcharge or a taxi rip-off, also call your bank's fraud line directly — the number on the back of your card — because fraud desks sometimes freeze faster than the Visa or Mastercard emergency lines.
...
Email your travel-insurance provider with a summary of what happened, timestamps, the denuncia number, and photographs of the bill. Even if you are not sure whether the loss is covered, opening the claim early protects your position.
...
File a formal complaint with **Cittadinanzattiva** — Italy's main consumer-protection body — at **[cittadinanzattiva.it](https://www.cittadinanzattiva.it)**. They do not recover individual losses directly, but they aggregate complaints that drive regulatory action, and they have active investigations into low-cost rental scams, taxi overcharging, and tourist-menu abuse that your report can feed.

For restaurant overcharging and tourist-menu traps, file a parallel complaint with the local *Comune* through its consumer-affairs line. Rome, Milan, Florence, Venice, and Bologna all have consumer-affairs portals with dedicated tourist-scam intake forms, and every Comune is required by law to investigate reported violations of the posted-menu rule.
