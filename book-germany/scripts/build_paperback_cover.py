#!/usr/bin/env python3
"""
Build the KDP paperback wraparound cover PDF for the Germany book.
...
OUT_SVG = BOOK / "build" / "germany-paperback-cover.svg"
OUT_PDF = BOOK / "build" / "germany-paperback-cover.pdf"
...
def main() -> None:
  ...
  <!-- ================================================================ -->
  <!-- GERMANY PAPERBACK WRAPAROUND COVER                                 -->
...
{back_inner}
  ...
  <g transform="translate({spine_cx} {cover_cy}) rotate(-90)">
    <text x="0" y="-4" font-family="Georgia, serif" font-weight="700" font-size="20"
          fill="#F5E9D3" text-anchor="middle" letter-spacing="3">GERMANY</text>
