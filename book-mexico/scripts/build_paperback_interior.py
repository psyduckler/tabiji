#!/usr/bin/env python3
"""
Build the paperback-interior PDF for the Spain book.
...
_OUT_NAME = CONFIG.get("output_filename", "scams")
INTERIOR_HTML = BUILD / f"{_OUT_NAME}-paperback.html"
INTERIOR_PDF = BUILD / f"{_OUT_NAME}-paperback.pdf"
...
def build_html(md: str) -> Path:
    ...
    title = CONFIG.get("title", "Spain Tourist Scams 2026")
